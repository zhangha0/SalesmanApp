...
import com.wzj.work.salesmanapp.Activity.AddGroupBuyActivity;
...
public class RecycleBuyAdapter extends RecyclerView.Adapter<RecycleBuyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        x.image().bind(holder.imageView, context.getResources().getString(R.string.http_tu) + foodList.get(position).ImageUrl);
        ...
        holder.tv_re.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putSerializable("groupBuy", foodList.get(position));
                Intent intent = new Intent(context, AddGroupBuyActivity.class);
        ...
        holder.tv_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("是否删除该团购?"); //设置内容
                builder.setPositiveButton("删除", new DialogInterface.OnClickListener() { //设置确定按钮
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        RequestParams params = new RequestParams(context.getResources().getString(R.string.http_msg) + "/Food/DeleteGroupFood");
